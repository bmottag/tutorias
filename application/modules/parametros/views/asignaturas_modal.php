			...
			<div class="col-sm-12">
				...
				<select name="programa" id="programa" class="form-control" >
					...
					<?php for ($i = 0; $i < count($programa); $i++) { ?>
						<option value="<?php echo $programa[$i]["id_param_programas"]; ?>" <?php if($information[0]["fk_id_param_programas"] == $programa[$i]["id_param_programas"]) { echo "selected"; }  ?>><?php echo $programa[$i]["programa"]; ?></option>	
					<?php } ?>
				</select>
				</div> 
			</div>
