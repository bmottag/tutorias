  ...
  <div class="login-box-body">
	...
	<form  name="form" id="form" role="form" method="post" action="<?php echo base_url("login/validateUser"); ?>" >
      <div class="form-group has-feedback">
        <input type="email" id="inputLogin" name="inputLogin" class="form-control" placeholder="Email">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat" id='btnSubmit' name='btnSubmit'>Ingresar</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
